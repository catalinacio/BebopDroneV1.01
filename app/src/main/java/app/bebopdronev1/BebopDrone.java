...
public class BebopDrone {
    ...
    private SDCardModule01 mSDCardModule01;
    ...
    public BebopDrone(Context context, @NonNull ARDiscoveryDeviceService deviceService) {
        ...
        if (ARDISCOVERY_PRODUCT_FAMILY_ENUM.ARDISCOVERY_PRODUCT_FAMILY_ARDRONE.equals(family)) {
            ...
            try
            {
                ...
                mSDCardModule01 = new SDCardModule01(ftpListManager, ftpQueueManager);
                mSDCardModule01.addListener(mSDCardModuleListener);
            }
    ...
    public void getLastFlightMedias() {
        ...
        if ((runId != null) && !runId.isEmpty()) {
            mSDCardModule01.getFlightMedias(runId);
        } else {
            Log.e(TAG, "RunID not available, fallback to the day's medias");
            mSDCardModule01.getTodaysFlightMedias();
        }
    }

    public void cancelGetLastFlightMedias() {
        mSDCardModule01.cancelGetFlightMedias();
    }
    ...
    private final SDCardModule01.Listener mSDCardModuleListener = new SDCardModule01.Listener() {
        @Override
