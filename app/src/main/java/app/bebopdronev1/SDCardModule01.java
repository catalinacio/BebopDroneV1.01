...
public class SDCardModule01 {

    private static final String TAG = "SDCardModule01";
    ...
    public SDCardModule01(@NonNull ARUtilsManager ftpListManager, @NonNull ARUtilsManager ftpQueueManager) {
